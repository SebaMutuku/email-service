...
public class SendMail {
    ...
    public SendMail(String host, int port, String emailUsername, String emailPassword) {
    ...
    public static void main(String[] args) {
        ...
        SendMail sendMail = new SendMail(host, port, mailuserName, mailPassword);
